          ...
          <div class="row padding-two sm-text-center" style="padding-top:20px;padding-bottom: 43px;">
            <div class="col-md-9 no-padding stay-tuned">
              ...
              <p class="white-text" style="font-family:sans-serif;text-align:justify;color:white">It has been our
                utmost desire to introduce an outstanding and easy to use matrimonial application for IOS and Android
                users. We have been working hard in this stance and are planning to come up with a user-friendly and
                secure Matrimonial App so that our users stay updated while on the go!</p>
              <p class="white-text" style="font-family:sans-serif;text-align:justify;color:white">The app will be soon
                available for both Android and Apple iPhone users in the respective play stores. Stay tuned for the
                launch of our ‘Kabool Hai Matrimonial app’ as the early birds will be given early access and will get
                free subscription.</p>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-md-3">
              <table>
                ...
                <tr>
                  <td class="flinks"><a href="#"><i class="fa fa-facebook-square fa-3x"></i> <i class="fa fa-youtube-square fa-3x"></i>
                      <i class="fa fa-twitter-square fa-3x"></i> <i class="fa fa-google-plus-square fa-3x"></i> <i
            ...
            <div class="col-md-3">
              ...
              <div class="searchcontainer">
                <form action="{{ url('subscribe') }}" method="post">
                  {{ csrf_field() }}
                  <input type="text" class="form-control" style="height:44px;width:225px;border-radius-left: 5%;"
