          ...
          {{ url('inbox') }}" class="menudesign">Inbox</a></li>
              ...
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu lenght" style="width: 500px !important; height:400px !important; overflow-y: scroll !important;background-color: #ffffff;">
        ...
        <div class="row padding-two sm-text-center">
          <div class="col-md-9 no-padding" id='stay-tuned-container'>
            ...
            <p class="white-text" style="font-family:sans-serif;text-align:justify;">It has been our utmost desire to
              introduce an outstanding and easy to use matrimonial application for IOS and Android users. We have been
              working hard in this stance and are planning to come up with a user-friendly and secure Matrimonial App
              so that our users stay updated while on the go!</p>
            <p class="white-text" style="font-family:sans-serif;text-align:justify;">The app will be soon available for
              both Android and Apple iPhone users in the respective play stores. Stay tuned for the launch of our
              ‘Kabool Hai Matrimonial app’ as the early birds will be given early access and will get free
              subscription.</p>
          </div>
      ...
      <div class="row">
        ...
        <div class="col-md-3">
          <table>
            ...
            <tr>
              <td class="flinks"><a href="https://www.facebook.com/Saykaboolhai/" target="__blank"><i class="fa fa-facebook-square fa-3x"></i></a><a
                  href="#"><i class="fa fa-youtube-square fa-3x"></i></a> <a href="https://twitter.com/kaboolhaitweet"
                  target="__blank"><i class="fa fa-twitter-square fa-3x"></i></a><i class="fa fa-google-plus-square fa-3x"></i><i
                  class="fa fa-linkedin-square fa-3x" style="color:white;"></i></a></td>
            </tr>
          </table>
        </div>
        <div class="col-md-3">
          ...
          <div class="searchcontainer">
            <form action="{{ url('subscribe') }}" method="post">
              {{ csrf_field() }}
              <input type="text" required="" class="form-control" style="height:44px;width:225px;border-radius-left: 5%;"
                placeholder="Enter Your Email" name="search">
            ...
            response.forEach(function (item) {
              ...
              if (item.attached) {
                ...
                if (valid_extensions.test(filename)) {
                  $('.new_message').append('<li><div class="left-chat"><p><a href="{{ url('
                    public / user_assets / attached ') }}/' + item.attached +
                    '" target="_blank"><img src="{{ url('
                    public / user_assets / attached ') }}/' + item.attached + '"></a></p></div></li>');
                  $('#chat-scroll').animate({
                  ...
                  $('.new_message').append('<li><div class="left-chat"><p><a href="{{ url('
                    public / user_assets / attached ') }}/' + item.attached + '" target="_blank">' +
                    item.attached + '</a></p></div></li>');
                  $('#chat-scroll').animate({
                    scrollTop: $('#chat-scroll').get(0).scrollHeight
                  }, 10);
              ...
              //  }
                ...
                $(".new_message").append('<li><div class="left-chat"><p>' + item.message +
                  '</p></div></li>');
                $('#chat-scroll').animate({
                  scrollTop: $('#chat-scroll').get(0).scrollHeight
                }, 10);
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          if (message && file) {
            ...
            $('.new_message').append('<li><div class="right-chat"><p><a href="{{ url('
              public / user_assets / attached ') }}/' + response.attached +
              '" target="_blank"><img src="{{ url('
              public / user_assets / attached ') }}/' + response.attached + '"></a></p></div></li>');
            $('#chat-scroll').animate({
              scrollTop: $('#chat-scroll').get(0).scrollHeight
            }, 10);
          } else if (file) {
            ...
            if (valid_extensions.test(filename)) {
              ...
              $('.new_message').append('<li><div class="right-chat"><p><a href="{{ url('
                public / user_assets / attached ') }}/' + response.attached + '" target="_blank">' +
                response.attached + '</a></p></div></li>');
              $('#chat-scroll').animate({
                scrollTop: $('#chat-scroll').get(0).scrollHeight
              }, 10);
