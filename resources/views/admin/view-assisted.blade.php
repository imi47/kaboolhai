...
<section id="main-content" class=" ">
    ...
    <div class='col-xs-12'>
        <div class="page-title">
            ...
            <div class="pull-left">
                <!-- PAGE HEADING TAG - START --><h1 class="title">View All Assisted</h1><!-- PAGE HEADING TAG - END -->                            </div>
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="{{ url('admin/view-assisted') }}">View All Assisted</a>
                        </li>
...
<div class="col-lg-12">
    <section class="box ">
            <header class="panel_header">
                <h2 class="title pull-left">View All Assisted</h2>
...
@if(Session::has('error'))
            ...
            <table class="table table-striped" >
                ...
                <tbody>
                @foreach ($assisted as $row)
                    <tr>
                     	<td >{{ $row->assisted_id }}</td>
                        <td >{{ $row->fullname }}</td>
                        <td>{{ $row->email }}</td>
                            <td>{{ $row->phonenumber }}</td>
                        <td>{{ $row->presentlocation }}</td>
                        <td>
                        <a href="{{ url('admin/delete-assisted',$row->assisted_id) }}" onclick="return confirm('Are you sure you want to delete this assisted user?');" ><i class="fa fa-archive" title="delete"></i></a>
                        </td>
