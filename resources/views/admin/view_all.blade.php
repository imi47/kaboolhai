...
<section id="main-content" class=" ">
    ...
    <div class='col-xs-12'>
        <div class="page-title">
            ...
            <div class="pull-left">
                <!-- PAGE HEADING TAG - START --><h1 class="title">View All</h1><!-- PAGE HEADING TAG - END -->                            </div>
...
<div class="col-lg-12">
    <section class="box ">
            <header class="panel_header">
                <h2 class="title pull-left">View All Rishta Users</h2>
            ...
            <table class="table table-striped">
                ...
                @foreach ($user_data as $row)
                    <tr>
                        ...
                        {{-- <a href="{{ url('admin/edit_user',$row->id) }}"><i class="fa fa-edit" title="Edit"></i></a>| --}}
                        <a href="{{ url('admin/user-archive',$row->id) }}" onclick="return confirm('Are you sure you want to Archive this user?');" ><i class="fa fa-archive" title="Un Archive"></i></a>
                        </td>
