...
@extends('admin/master_layout')
 @section('data')
    ...
    <div class='col-xs-12'>
        <div class="page-title">
        	@if(Session::has('error'))
                ...
                @endif
            <div class="pull-left">
                <!-- PAGE HEADING TAG - START --><h1 class="title">Add Latest Update</h1><!-- PAGE HEADING TAG - END -->                            </div>
    ...
    <div class="row">
    <form action ="{{ url('admin/add-update') }}" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
                            ...
                            <div class="controls">
                                <input type="text" name="page_name" placeholder="Enter page name" class="form-control" >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <span class="desc"></span>
                            <div class="controls">
                                <input type="url" name="page_url" placeholder="Enter page url" class="form-control" >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <span class="desc"></span>
                                                        <img class="img-responsive" src="../data/blo-users/user-1.jpg" alt="" style="max-width:120px;">
                                                        <div class="controls">
