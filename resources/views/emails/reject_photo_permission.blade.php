...
<div style="width: 100%; 
	...
	position: relative;" >
				...
				<tr>
					<td>
						<h1>Reject Photo Permission Email</h1>
					</td>
				</tr>
				<tr class="text-content">
					<td>
						<p >Hey {{ $user_date->firstname.' '.$user_date->lastname}} , Reject your photo permision request,{{ $sender_user->firstname.' '.$sender_user->lastname}}<br/>Please click below link for view profile.
						</p>
