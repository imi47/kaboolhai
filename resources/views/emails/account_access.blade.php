...
<div style="width: 100%; 
	...
	position: relative;" >
				...
				<tr class="text-content">
					<td>
						<p >Hey {{ $user_date->firstname.' '.$user_date->lastname}} , Access Your account by new device<br/>Please click below link for view Kaboolhai.
						</p>
				...
				<tr>
					<td>
						...
						<a  style="text-decoration: none;background-color:#009688;color: #fff;padding: 10px;position: absolute;top: 76%;right: 163px;border-radius: 10%" href="{{ url('/') }}">Kaboolhai.com</a>
